...
export default class Talking extends Command {
  constructor() {
    super({
      name: "talk",
      description: "Bicara sebagai sweetie.",
      args: [
      ...
      example:
        "talk --channel=454637409288847371 --server=454637408479084566 Asdasdasd",
      ownerOnly: true,
    });
  }
  ...
  public async run(
    ...
    returnable.channelID =
      message.mentions.channels.first() || args.channel || message.channel.id;
